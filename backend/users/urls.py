...
from users.views import (
    ...
    CvAuditView,
    CvImproveView,
    MyCompanyInterestRespondView,
    MyCompanyInterestsListView,
...
urlpatterns = [
    ...
    path(
        "me/company-interests/",
        MyCompanyInterestsListView.as_view(),
        name="user-company-interests",
    ),
    path(
        "me/company-interests/<int:interest_id>/respond/",
        MyCompanyInterestRespondView.as_view(),
        name="user-company-interest-respond",
    ),
