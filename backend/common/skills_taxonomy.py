...
HARD_SKILLS: frozenset[str] = frozenset({
    ...
    'react', 'angular', 'vue', 'next', 'nuxt', 'svelte',
    ...
    'jenkins', 'circleci', 'travisci', 'ci/cd',
    'terraform', 'ansible', 'vagrant',
    'linux', 'bash', 'powershell',

    # API & protocols
    'rest', 'graphql', 'soap', 'websocket', 'json', 'xml',
    ...
    'postman', 'junit', 'pytest', 'unittest',

    # Databases
    'sql', 'mysql', 'postgresql', 'sqlite', 'oracle', 'mssql',
    'mongodb', 'cassandra', 'firebase', 'redis', 'elasticsearch',

    # Data & AI
    'pandas', 'numpy', 'scikit-learn', 'tensorflow', 'keras', 'pytorch',
    'openai', 'bigquery', 'power bi', 'tableau',
    'machine learning', 'data science',

    # Project & agile
    'agile', 'lean', 'scrum', 'kanban',
    'jira', 'confluence', 'notion', 'clickup', 'trello',
    'uml', 'bpmn',

    # Design & marketing
    'figma', 'photoshop', 'illustrator', 'xd',
    'seo', 'sem', 'ecommerce', 'woocommerce', 'shopify',
