...
@Component({
  ...
  template: `
    <div class="space-y-2">
      ...
      <!-- Error Message -->
      <p *ngIf="error" [id]="id + '-error'" class="text-xs text-error-500 flex items-center gap-1">
...
export class FormFieldComponent implements ControlValueAccessor {
  ...
  getInputClasses(): string {
    const baseClasses =
      'block w-full bg-white dark:bg-dark-bg-tertiary border rounded-xl text-gray-900 dark:text-dark-text-primary placeholder-gray-400 dark:placeholder-gray-500 focus:ring-2 focus:border-transparent transition-all duration-200';
