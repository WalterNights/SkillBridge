  ...
  template: `
    ...
    >
      ...
      <div class="flex items-start gap-4 mb-4">
        <div
          class="w-14 h-14 rounded-xl bg-gray-100 dark:bg-dark-bg-tertiary flex items-center justify-center shrink-0 overflow-hidden"
        >
          <img
        ...
        <div class="flex-1 min-w-0">
          <h3
            class="text-lg font-semibold text-gray-900 dark:text-dark-text-primary truncate group-hover:text-primary-600 dark:group-hover:text-primary-400 transition-colors"
          >
            {{ job.title }}
          </h3>
      ...
      <div class="flex flex-wrap gap-2 mb-4">
        ...
        <app-badge *ngIf="job.remote" variant="secondary" size="sm"> Remoto </app-badge>

        <app-badge *ngIf="job.salary" variant="accent" size="sm">
          <svg class="w-3 h-3 mr-1" fill="currentColor" viewBox="0 0 20 20">
            <path
      ...
      <div class="mb-4">
        <div class="flex items-center justify-between mb-2">
          ...
          <span class="text-xs font-semibold" [class]="getSkillsMatchClasses()">
